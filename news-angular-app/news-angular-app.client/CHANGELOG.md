...
- Create Angular project with ng: `ng new news-angular-app.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`news-angular-app.client.esproj`).
